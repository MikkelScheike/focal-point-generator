...
export function FocalMarker({ point, size = "md", interactive = false }: FocalMarkerProps) {
  ...
  return (
    ...
    >
      {interactive ? (
        <span className={`absolute top-1/2 left-1/2 ${hit} -translate-x-1/2 -translate-y-1/2`} />
      ) : null}
      <span
